...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // EN translations from EN_CONTENT (auto-generated by scrape/build-en-content.mjs).
  // Without this loop, the ~120 EN apex pages on disk are invisible to Google's
  // sitemap crawler — they only get discovered via internal links / hreflang.
